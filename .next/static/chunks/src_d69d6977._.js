...
;
;
function PatternCanvas({ patternType, primaryColor, secondaryColor, scale, onPatternGenerated }) {
    _s();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PatternCanvas.useEffect": ()=>{
            ...
            try {
                ...
                switch(patternType){
                    case "stripes":
                        drawStripes(ctx, primaryColor, secondaryColor, scale);
                        break;
                    case "grid":
                        drawGrid(ctx, primaryColor, secondaryColor, scale);
                        break;
                    case "dots":
                        drawDots(ctx, primaryColor, secondaryColor, scale);
                        break;
                    default:
                        drawStripes(ctx, primaryColor, secondaryColor, scale);
                }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
        className: "p-4 w-full aspect-square max-w-2xl mx-auto",
        children: [
...
_s(PatternCanvas, "Dy3TPKK3wULJpN7pcN02ipRym8k=");
_c = PatternCanvas;
// Pattern drawing functions
function drawStripes(ctx, primary, secondary, scale) {
    const width = ctx.canvas.width;
    const height = ctx.canvas.height;
    const stripeWidth = Math.max(10, 50 * (scale / 100));
...
function drawGrid(ctx, primary, secondary, scale) {
    const width = ctx.canvas.width;
    const height = ctx.canvas.height;
    const gridSize = Math.max(10, 50 * (scale / 100));
    ctx.fillStyle = secondary;
    ctx.fillRect(0, 0, width, height);
    ctx.fillStyle = primary;
...
function drawDots(ctx, primary, secondary, scale) {
    const width = ctx.canvas.width;
    const height = ctx.canvas.height;
    const spacing = Math.max(20, 100 * (scale / 100));
...
_s(PatternControls, "QrGkrca17WEc03OGJo6iDdiv6UI=");
_c = PatternControls;
var _c;
...
function PatternGenerator() {
    ...
    const handlePatternUpdate = (settings)=>{
        setCurrentPattern(settings);
    };
...
_s(PatternGenerator, "CDOrbLbBa9sUFL4f//Zoe7e64qo=");
_c = PatternGenerator;
var _c;
...
//# sourceMappingURL=src_d69d6977._.js.map